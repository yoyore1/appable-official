...
import { AppableBuilderChannel } from '../../workbench/contrib/void/electron-main/appableBuilderChannel.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Appable Builder engine channel (loads void/.env.local via appRoot)
		const appableBuilderChannel = new AppableBuilderChannel(accessor.get(IEnvironmentMainService).appRoot);
		mainProcessElectronServer.registerChannel('void-channel-appable', appableBuilderChannel);
